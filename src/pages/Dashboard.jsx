...
// Format response time into a readable duration
function formatResponseTime(createdAt, resolvedAt) {
  ...
  if (days > 0) {
    return `Resolved in ${days}d ${hours}h ${minutes}m`
  }
  ...
  if (minutes > 0) {
    return `Resolved in ${minutes}m ${seconds}s`
  }

  return `Resolved in ${seconds}s`
}
                    ...
                    <Popup>
                      <div style={{ width: "240px" }}>
                        ...
                        <div>
                          ...
                          {report.barangay || "Location from map"}
                        </div>
